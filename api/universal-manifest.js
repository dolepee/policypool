  ...
  return async function handler(req, res) {
    ...
    return sendJson(res, 200, {
      ...
      contracts: {
        ...
        policyFeeEscrow: configuration.feeEscrow,
      },
      endpoints: {
        ...
        directA2mcpCheckout: "/api/direct-a2mcp",
        reconciliation: "/api/reconcile-universal",
        directA2mcpReconciliation: "/api/reconcile-direct-a2mcp",
      },
      safety: {
        ...
        directA2mcp: {
          enabled: configuration.directA2mcpEnabled === true,
          transport: "direct_http_x402_not_okx_task_marketplace",
          paymentOrder: ["covenant_issue", "refundable_fee_escrow", "provider_settlement", "fee_capture"],
          feeEscrow: "refund_after_unsettled_authorizations_expire_or_capture_after_verified_provider_settlement",
          feeAmountAtomic: configuration.directFeeAtomic,
          enrollmentPricing: "policy_premium_bps_derived_from_fixed_fee_and_selected_cap",
          replay: "same_quote_and_same_two_authorizations_only",
          ambiguousProviderSettlement: "recover_by_indexed_eip3009_nonce_without_recharging",
          missingSettledResponse: "manual_safety_hold_without_provider_retry_or_automatic_breach",
        },
